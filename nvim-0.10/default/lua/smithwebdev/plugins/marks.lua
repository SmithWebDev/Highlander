return{
  ...
  config = function()
    ...
    -- TODO: Keymap Strategy <smithwebdev smithwebdd@gmail.com> 
    vim.keymap.set('n', '<leader>ma', ':MarksListAll<CR>',    { desc = 'Show all marks on current file', silent = true })
    vim.keymap.set('n', '<leader>mb', ':MarksListBuf<CR>',    { desc = 'Show all buffer marks', silent = true })
    vim.keymap.set('n', '<leader>mg', ':MarksListGlobal<CR>', { desc = 'Show all global marks', silent = true })
  end,
}
